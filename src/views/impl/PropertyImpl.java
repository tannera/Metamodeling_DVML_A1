...
public class PropertyImpl extends NamedElementImpl implements Property {
	 ...
	 * @ordered
	 */
	protected static final PropertyType TYPE_EDEFAULT = PropertyType.CLASS;
	...
	public views.Class getClass_() {
		if (class_ != null && class_.eIsProxy()) {
			...
			if (class_ != oldClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewsPackage.PROPERTY__CLASS, oldClass, class_));
			}
		}
		return class_;
	}
	...
	public void setClass(views.Class newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewsPackage.PROPERTY__CLASS, oldClass, class_));
	}
