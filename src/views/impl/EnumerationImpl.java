 ...
 * </p>
 * <ul>
 *   <li>{@link views.impl.EnumerationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends NamedElementImpl implements Enumeration {
	...
	public EList<Literal> getLiteral() {
		if (literal == null) {
			literal = new EObjectContainmentEList<Literal>(Literal.class, this, ViewsPackage.ENUMERATION__LITERAL);
		}
		return literal;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ViewsPackage.ENUMERATION__LITERAL:
